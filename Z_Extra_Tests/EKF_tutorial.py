...
plt.rcParams.update({
    'figure.figsize':   (7, 7),   # square figure
    'axes.titlesize':   14,
    'axes.labelsize':   12,
    'legend.fontsize':  10,
    'xtick.labelsize':  10,
...
from StoneSoupID.stonesoupID.predictor.kalman import ExtendedKalmanPredictor
predictor = ExtendedKalmanPredictor(transition_model)

from StoneSoupID.stonesoupID.updater.kalman import ExtendedKalmanUpdater
